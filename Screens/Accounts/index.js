    ...
    <SafeAreaView style={styles.safeArea}>
        <View style={{ paddingVertical: 18, paddingHorizontal: 20 }}>
            ...
            <View style={[styles.balanceCard, { backgroundColor: COLORS.SKELETON, opacity: 0.5 }]}>
                <SkeletonPulse style={{ width: 100, height: 15, borderRadius: 4, marginBottom: 18 }} />
                <SkeletonPulse style={{ width: '40%', height: 12, borderRadius: 4, marginBottom: 8 }} />
                <SkeletonPulse style={{ width: '70%', height: 40, borderRadius: 8 }} />
            </View>

            {/* Assets List Skeleton */}
            <View style={[styles.assetList, { paddingVertical: 13, paddingHorizontal: 15 }]}>
                {[1, 2, 3].map((i) => (
...
const Accounts = () => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#F5F5DC' }}>
            ...
            <SafeAreaView style={styles.safeArea}>
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 98 }}>
...
const styles = StyleSheet.create({
    ...
    cardNumber: { color: '#FFF', letterSpacing: 1, fontFamily: FONTS.regular },
    currencyBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF', paddingVertical: 2, borderRadius: 10, paddingHorizontal: 8 },
    currencyText: { fontSize: 12, fontFamily: FONTS.bold, marginRight: 4 },
    balanceLabel: { color: '#FFF', fontSize: 14, fontFamily: FONTS.regular, marginBottom: 6 },
    balanceAmount: { fontSize: 36, fontFamily: FONTS.bold, color: '#FFF' },
    decimal: { fontSize: 20, fontFamily: FONTS.regular, color: '#FFF' },
    assetList: {
    ...
    assetItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 13, paddingHorizontal: 15, borderBottomWidth: 1, borderBottomColor: '#F0F0F0' },
    assetIconArea: { width: 35, height: 35, borderRadius: 12, justifyContent: 'center', alignItems: 'center', marginRight: 15 },
    assetLabelText: { fontFamily: FONTS.medium, color: COLORS.TEXT_MAIN, fontSize: 14 },
    assetValue: { fontFamily: FONTS.bold, color: COLORS.TEXT_MAIN, fontSize: 14 },
});